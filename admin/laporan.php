...
$q6 = "SELECT COUNT(id_test_drive) as jml FROM tbl_test_drive";
	...
	<div class="row">
		<div class="col-md-6 col-xl-3">
			<div class="mini-stat clearfix bg-orange">
				<span class="font-40 text-white mr-0 float-right"><i class="mdi mdi-currency-usd"></i></span>
		...
		<div class="col-md-6 col-xl-3">
			<div class="mini-stat clearfix bg-success">
				<span class="font-40 text-white mr-0 float-right"><i class="mdi mdi-car"></i></span>
				<div class="mini-stat-info mt-3 float-left">
		...
		<div class="col-md-6 col-xl-3">
			<div class="mini-stat clearfix bg-purple">
				...
				<div class="mini-stat-info mt-3 float-left">
					<span style="font-size: small;" class="text-white">Form Test Drive</span>
				</div>
				<div class="clearfix"></div>
				<p class=" mb-0 m-t-10 text-muted">
					<h4 class="counter font-light mt-0 text-white"><?php echo number_format($dta6['jml']); ?> Form</h4>
				</p>
			</div>
		</div>
	</div>
