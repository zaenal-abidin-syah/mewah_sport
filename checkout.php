...
<div class="content">
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="card">
                    <div style="background-color: #FCEBD0" class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="provinsi" id="provinsi"
                                    class="all_province form-control" onchange="get_kota(this);" required>
            ...
            <div class="col-md-6">
                                ...
                                <table class="table" style="font-size: small;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $diskon_persen = 20;
                                            $diskon = ($subharga * $diskon_persen) / 100;
                                            $subdiskon = $subharga - $diskon;
                                        ?>
                                        <tr>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        Rp. <span id="subtotal"
                                            name="subtotal"><?php echo number_format($subdiskon); ?></span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        Rp. <span name="ongkir" id="ongkir"></span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <h6 class="text-danger"> Rp. <span id="total_order"
                                            name="total_order"><?php echo number_format($subtotal); ?></span></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                if (isset($_POST['pesan'])) {
                    ...
                    $diskon_persen2 = 20;
                    $diskon2 = ($totalbayar * $diskon_persen2) / 100;
