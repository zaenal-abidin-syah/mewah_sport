    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h4 style="color: #1D3B28">
                            Form Konfirmasi Pembayaran
                        </h4>
                        <p style="color: #1D3B28">Mohon untuk melengkapi data di bawah ini untuk melakukan konfirmasi</p>
                        <?php
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Pilih Bank :</label>
                                <select type="text" class="form-control" name="nmBank" required="required">
                            ...
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Jumlah Transfer</label>
                                <select type="number" class="form-control" name="jml_transfer" required="required">
                                    <option value="<?php echo number_format($data['total_order'])?>"><?php echo number_format($data['total_order'])?></option>
                                </select>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body alert-danger">
                        <p style="color: #1D3B28">Total Tagihan :</p>
                        <h1 style="color: #1D3B28">Rp. <?php echo number_format($data['total_order'], 0,',','.'); ?></h1>
                    </div>
                </div>
            </div>
        </div>
