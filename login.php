...
<body>
    <div class="signup-form">
        ...
        ?>
        <a href="index.php"><button class="btn btn-danger home-button">Home</button></a>
        <br><br>
        <a href="admin/login-admin.php"><button type="button" class="btn btn-primary" >Admin</button></a>
    </div>
</body>
