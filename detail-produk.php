...
?>
<div class="container rounded pt-4 pb-4" style="background-color: #FCEBD0;" id="containt">
    <div class="row">
        ...
        <div class="col-md-7 col-sm-12 pt-3 pl-5">
            ...
            <hr>
            <h3 class="text-danger"><span class="text-secondary" style="font-size: 15px">
            ...
            <form method="post">
                ...
                <div class="row mt-4">
                    <div class="col-md-5">
                            <a href="test-drive.php?id=<?php echo $produk['id_produk']; ?>" class="btn btn-primary btn-block" name="test-drive">
                                <i class="fa fa-shopping-cart" aria-hidden="true"></i> Test Drive
                            </a>
                    </div>
                </div>
        </div>
        ...
        <?php
                ...
                if (isset($_POST['test-drive'])) {
                    if (!isset($_SESSION["pelanggan"])) {
                        ...
                        echo "<script>location='test-drive.php';</script>";
                        // echo "<meta http-equiv='refresh' content='1;url=tes-drive.php'>";
                    }
                }
            ?>
    </div>
    ...
    <div class="ProdukDesc">
        <div class="row">
            <div class="col-md-2">
                <button class="btn" style="color: black; background-color:#BA9F38;" id="btnDesc1">DESCRIPTIONS</button>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12" style="background-color: #E1CC96;">
